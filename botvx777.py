...
class LotteryBot:
    ...
    def sign_md5(self, data_dict): # အဆင့်ကို ပြန်ထားပါ
        """Generate MD5 signature for API requests"""
        sign_data = data_dict.copy()
        if 'signature' in sign_ # အဆင့်ကို ပြန်ထားပါ
            del sign_data['signature'] # အဆင့်ကို ပြန်ထားပါ
        if 'timestamp' in sign_ # အဆင့်ကို ပြန်ထားပါ
            del sign_data['timestamp'] # အဆင့်ကို ပြန်ထားပါ
        ...
        return md5_hash # အဆင့်ကို ပြန်ထားပါ

    def random_key(self): # အဆင့်ကို ပြန်ထားပါ
