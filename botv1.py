...
class LotteryBot:
    def __init__(self, platform='ck'):
        ...
        # ✅ Updated headers for CK platform with correct domain
        if platform == 'ck':
            self.headers = {
    ...
    """Login to Lottery API - DEBUG VERSION"""
    try:
        # Use updated random key generation
        ...
        body = {
            ...
            "logintype": "mobile",
            "random": random_key,
            "username": f"95{phone}",  # ✅ 95 prefix added
            "pwd": password,
        ...
        print(f"🔧 DEBUG: Login attempt for {phone} on {self.platform}")
        print(f"🔧 DEBUG: Using URL: {self.base_url}Login")
        print(f"🔧 DEBUG: Username: 95{phone}")
