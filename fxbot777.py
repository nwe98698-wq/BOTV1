...
# Admin ရဲ့ ID ကို အရင်ထည့်ပါ (ဥပမာ: 123456789)
ALLOWED_USER_IDS = [6328953001]  # ဒီနေရာမှာ Admin ရဲ့ နဲ့ အသုံးပြုခွင့်ပေးထားတဲ့ တကယ့် User IDs တွေကို ထည့်ပါ (ဥပမာ: [123456789, 987654321])
# ----------------------
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ... အခြား elif အပိုင်းများ ...
    # ... အစိတုတ်အပိုင်းများ ...

# အစိတုတ်အပိုင်းမှာ ဒါကိုထည့်ပါ
# အသုံးပြုသူစာရင်းထည့်တဲ့အမိန့်
if text.startswith('/adduser') and update.effective_user.id == 123456789: # ဒီနေရာမှာ Admin ရဲ့ ID ကိုထည့်ပါ
    try:
...
if text.startswith('/removeuser') and update.effective_user.id == 123456789: # ဒီနေရာမှာ Admin ရဲ့ ID ကိုထည့်ပါ
    try:
...
if text == '/listusers' and update.effective_user.id == 123456789: # ဒီနေရာမှာ Admin ရဲ့ ID ကိုထည့်ပါ
...
# ... အခြား elif အပိုင်းများ ...
    ...
    if current_user_id in ALLOWED_USER_IDS:
        ...
        await update.message.reply_text(
            f"ID မှားနေရင် Admin Contact @Smile_p2\n"
